        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-secondary rounded-full border border-border mb-8">
            ...
            <span className="text-sm font-medium text-muted-foreground">
              University-Educated Analyst Programmers
            </span>
          </div>

          {/* Headline */}
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-primary leading-tight mb-6 text-balance">
            NavArrow: Your Integrated{" "}
            <span className="text-accent">Technology Partner</span>
          </h1>

          {/* Subheadline */}
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed text-pretty">
            We empower businesses with professional web development and specialized 
            technical support. High-performance solutions for the modern era.
          </p>
          ...
          <div className="mt-20 grid grid-cols-3 gap-8 max-w-lg mx-auto">
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-sm font-medium text-muted-foreground">Modern Stack</span>
            </div>
            <div className="flex flex-col items-center gap-2">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-sm font-medium text-muted-foreground">High Performance</span>
            </div>
          </div>
        </div>
      </div>
